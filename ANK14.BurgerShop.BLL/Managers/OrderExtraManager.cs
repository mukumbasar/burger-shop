...
{
    public class OrderExtraManager : BaseManager<OrderExtra, OrderExtraDto>, IOrderExtraService
    {
        public OrderExtraManager(IMapper mapper, IUow uow) : base(mapper, uow)
        {
